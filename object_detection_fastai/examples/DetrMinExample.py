# clone https://github.com/facebookresearch/detr add detr 
import sys
...
from object_detection_fastai.models.Detr import DETRFastAiSimple
...
model = DETRFastAiSimple(body, num_classes, num_layers=2)
...
data = (ObjectItemList.from_folder(coco)
            ...
            .databunch(bs=bs, collate_fn=bb_pad_collate)) #, num_workers=1
